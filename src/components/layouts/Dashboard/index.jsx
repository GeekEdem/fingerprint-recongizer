...
var HomePage = React.createClass({
  ...
  render: function() {
    ...
    var title = <span><a href="/" title="Fingerprint recognition system" rel="home">Fingerprint recognition system</a></span>;
            ...
            <div className="row"> 
              <div className="col-sm-3 col-md-2 sidebar"> 
                <div className="text-center"> 
                  <h2 className="brand">Fingerprint recognition<br /><small>dashboard</small></h2>
                ...
                <ul className="nav nav-sidebar"> 
                  <li>
                    <Link to="/dashboard/overview">Users</Link>
                  </li> 
                  <li>
